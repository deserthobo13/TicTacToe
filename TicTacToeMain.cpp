...
public:
  ...
  {
    cout << endl << " " << arr[0].getValue () << " | " << arr[1].
      getValue () << " | " << arr[2].getValue () << " " << endl;
    cout << " " << arr[3].getValue () << " | " << arr[4].
      getValue () << " | " << arr[5].getValue () << " " << endl;
    cout << " " << arr[6].getValue () << " | " << arr[7].
      getValue () << " | " << arr[8].getValue () << " " << endl;
  }
};

string statusx (Game arr[])
{
  string status;
  if (arr[0].getValue () != '-' && arr[1].getValue () != '-'
      ...
      else
	{
      ...
      || arr[4].getValue () == '-' || arr[5].getValue () == '-'
      || arr[6].getValue () == '-' || arr[7].getValue () == '-'
      || arr[8].getValue () == '-')&&status!="win"&&status!="loss"&&status!="draw")
    {
      status = "playing";
    }
  return status;
